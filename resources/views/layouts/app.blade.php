...
<body>
    <header id="header" class="navbar-expand navbar-dark bg-dark mb-5 shadow-sm">
        <div class="container">
            <nav class="navbar">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img class="header_logo" src="https://api.faviconkit.com/alif.tj/144" alt="">
                </a>
    ...
    @include('components.errors_dialog')
