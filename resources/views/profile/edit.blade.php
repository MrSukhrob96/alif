...
@section('content')
<form action="{{ route('profile.update', ['profile' => $id]) }}" method="post" class="row g-3">
    @csrf
    @method('PATCH')
    ...
    <div class="col-md-8 mb-3">
        <input type="text" name="phone" class="form-control form-control-lg border-secondary input_border" placeholder="user phone number" value="" required>
    </div>
